...
public class WhenUsingReferralsApiUnitTests : BaseWhenUsingOpenReferralApiUnitTests
{
    ...
    public async Task ThenReferralsByReferrerAreRetrieved()
    {
        var request = new HttpRequestMessage
        {
            ...
            RequestUri = new Uri(_client.BaseAddress + "api/referrals/Bob Referrer?pageNumber=1&pageSize=10"),
        };
    ...
    public async Task ThenTheOpenReferralOrganisationIsCreated()
    {
        var command = new Referral(
                ...
                new List<ReferralStatus> { new ReferralStatus("1d2c41ac-fade-4933-a810-d8a040f0b9ee", "Inital-Referral") }
                );
